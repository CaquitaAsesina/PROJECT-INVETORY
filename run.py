...
from fronted import interfaz_encolar
import random
cola = Cola()


#AGREGAR(SAVE)
def agregar_final(codigo, nombre, apellido, correo, telefono, categoria):
...
def comando_agregar():
    ...
    titulo = Label(ventana, text="👤REGISTRAR USUARIO👤", font=("impact", 20), bg="#137bc0", fg="#E91313", relief="groove", border=2)
    titulo.place(x=45, y=15, width=350, height=45)

    label_codigo = Label(ventana, text="✅CODIGO:", font=("impact", 16), bg="#FFFFFF", fg="#FF0000", relief="raised", border=5)
    ...
    label_nombre= Label(ventana, text="✅NOMBRES:", font=("impact", 16), bg="#FFFFFF", fg="#FF0000", relief="raised", border=5)
    ...
    label_apellido= Label(ventana, text="✅APELLIDOS:", font=("impact", 16), bg="#FFFFFF", fg="#FF0000", relief="raised", border=5)
    ...
    label_correo= Label(ventana, text="✅CORREO:", font=("impact", 16), bg="#FFFFFF", fg="#FF0000", relief="raised", border=5)
    ...
    label_telefono= Label(ventana, text="✅TELOFONO:", font=("impact", 16), bg="#FFFFFF", fg="#FF0000", relief="raised", border=5)
    ...
    label_categoria= Label(ventana, text="✅CATEGORIA:", font=("impact", 16), bg="#FFFFFF", fg="#FF0000", relief="raised", border=5)
    ...
    agregar = Button(ventana, text="AGREGAR USUARIO ✅", command=lambda: agregar_final(entry_codigo.get(), entry_nombre.get(), entry_apellido.get(), entry_correo.get(), entry_telefono.get(), entry_categoria.get()), bg="#C7CDCE", fg="#F50404", font=("impact", 14), width=25, relief="groove", border=2)
...
def comando_eliminar_primero():
    ...
    titulo = Label(ventana, text="⚠️PRIMER USUARIO⚠️", font=("impact", 20), bg="#ffffff", fg="#E91313", relief="groove", border=2)
    titulo.place(x=20, y=15, width=300, height=45)

    usuario= Label(ventana, text=usuario, font=("Segoe U", 10), bg="#ACBEF0", fg="#000000", relief="raised", border=2, justify= "left")
    usuario.place(x=35, y=70, width=270, height=215)

    eliminar = Button(ventana, text="❌ELIMINAR PRIMERO❌", command=eliminar_primero_final(), font=("impact", 16), bg="#137bc0", fg="#E91313", relief="raised", border=5)
...
def comando_eliminar_ultimo():
    ...
    titulo = Label(ventana, text="⚠️ULTIMO USUARIO⚠️", font=("impact", 20), bg="#ffffff", fg="#E91313", relief="groove", border=2)
    titulo.place(x=20, y=15, width=300, height=45)
...
def comando_eliminar():
    ...
    titulo = Label(ventana, text="⚠️ELIMINAR USUARIO⚠️", font=("impact", 20), bg="#137bc0", fg="#E91313", relief="groove", border=2)
    titulo.place(x=20, y=15, width=300, height=45)
...
limpiar_boton = Button(ventana, text="LIMPIAR AGENDA🗑️", command=comando_agregar, font=("impact", 16), bg="#FFFFFF", fg="#000000", relief="raised", border=5)
limpiar_boton.place(x=55, y=290, width=230, height=45)

mostrar_boton = Button(ventana, text="VER AGENDA VIRTUAL📦", command=comando_agregar, font=("impact", 16), bg="#FFFFFF", fg="#000000", relief="raised", border=5)
